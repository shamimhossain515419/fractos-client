        ...
        <div className='md:flex lg:flex items-center'>
            ...
            <div className='md:w-3/4 lg:w-3/4'>
                <div className='md:flex lg:flex justify-between gap-3'>
                    <div className='shadow bg-blue-50 border-t-0  shadow-slate-500 p-3 border-2 w-full'>
                ...
                <div className='md:flex lg:flex justify-between gap-3 mt-8'>
                    <div className=' bg-blue-50 shadow border-t-0 h-52 shadow-slate-500 p-3 border-2 w-full'>
                        <p className='font-bold'>Achievement</p>
                    </div>
                    <div className='shadow bg-blue-50 border-t-0 h-52 shadow-slate-500 p-3 border-2 w-full'>
