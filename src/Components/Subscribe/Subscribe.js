               ...
               <div className='  '>
                    <div>
                         ...
                         <div className=' lg:flex justify-center items-center gap-2 mt-6'>
                              <div>
                                   <input className='text-black w-full md:w-[350px]  py-2 px-3  text-xl  font-normal  hover:outline-[#27895C]  border border-[#27895C]' type="text" placeholder='example@gmail.com' name="" id="" />
                              </div>
