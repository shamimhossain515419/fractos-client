...
<div className="md:flex bg-[#bfece3] border border-indigo-500  mx-4 my-6 rounded-lg ">
                        <div className='md:w-1/2  p-4 '>
                           <Image  width={100} height={100} src={course.Image} alt="download" border="0" className='w-full h-64 md:mt-4 p-4 rounded-lg  border-2 border-blue-500  '></Image>
                        </div>
                        <div className='md:w-1/2 text-indigo-700   mt-4 md:mt-12 p-4  '>
                            <h1 className='font-bold text-2xl '>{course.subject_name} Batch- {course.Batch}</h1>
                            <h2 className='mt-4'><span className='text-xl font-bold'>{course.teacherName} </span> {course.detail}</h2>
                     ...
                     <div className='mx-8 justify-center my-12  text-xl border border-indigo-500 p-4  rounded-lg text-sky-500'>
                         <div className='md:flex justify-between mx-4'>
                         <p className=''>Class Time: {course.day} </p>
                          <p>{course.class_time}</p>
                         </div>

                          <div className="md:flex justify-between mx-4">
                          <p className='mt-4 '>{course.no_of_class}  class taken in every week</p>
                          <p className='mt-4 '>{course.no_of_mockTest} live mock test taken in every week</p>
                          </div>
                           <div className='mt-4 md:flex justify-between mx-4'>
                            <p>Availabel Slot: {course.available_slot}</p>
                            <p className='mt-4 md:mt-0 md:ml-4'>Total Enrolled Students: {course.enroll_student}</p>
                           </div>

                           <div className='mx-4 mt-4 md:flex justify-between text-red-600'>
                             <p>Price: {course.fees}/=</p>

                             <button className='font-bold  border border-purple-700 rounded-lg  p-2 hover:bg-purple-300 hover:text-blue-900 text-[#3eeac5]  mt-4 md:mt-0'>Enroll Now</button>      
                           </div>
                        </div>
