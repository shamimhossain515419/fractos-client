...
const UserModal = () => {
    ...
    return (
        <div className=' primaryBg rounded-lg shadow-lg p-5 relative min-w-[320px]'>
            ...
            <Link className="p-2 rounded-lg border-2 border-[#0EE6B8] hover:bg-[#4A3AFF] hover:text-white transition-all block text-center w-full mb-5" href={'/dashboard/setting'}>Setting</Link>
