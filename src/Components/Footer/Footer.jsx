        ...
        <div className="footer-container grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-4 px-2 mt-10">
          ...
          <div className="footer-item w-full">
            <div className="footer-title lg:text-left sm:text-center md:text-center">
              ...
              <p className="mt-3 text-1xl font-bold  mb-1 cursor-pointer hover:duration-300 hover:text-red-500 hover:ms-2">
                About this project
              </p>
              <p className="text-1xl font-bold  mb-1 cursor-pointer hover:duration-300 hover:text-red-500 hover:ms-2">
                Contact us
              </p>
              <p className="text-1xl font-bold  mb-1 cursor-pointer hover:duration-300 hover:text-red-500 hover:ms-2">
                All courses
