        ...
        <div className="footer-container grid lg:grid-cols-4 md:grid-cols-2 sm:grid-cols-1 gap-4 px-2 mt-10">
          <div className="footer-item w-full ">
            ...
            <div className="footer-icon mt-3 flex flex-row space-x-4">
              <Link
                ...
                className="icon-box cursor-pointer w-[40px] h-[40px] bg-blue-500  rounded relative"
              >
              ...
              <Link
                ...
                className="icon-box w-[40px] h-[40px] bg-blue-500 rounded relative"
              >
          ...
          <div className=" w-full ">
            <div className=" lg:text-left sm:text-center md:text-center">
              <h2 className="text-3xl font-bold  primary uppercase">
                Information
              </h2>

              <Link
                href="/about"
                className="mt-3 text-1xl font-bold text-white  mb-1 cursor-pointer hover:duration-300 hover:text-[#0EE6B8] hover:ms-2 block"
              >
                About
              </Link>
              <Link
                href={"contact"}
                className="text-1xl font-bold  text-white  mb-1 cursor-pointer hover:duration-300 hover:text-[#0EE6B8] hover:ms-2 block"
              >
                Contact us
              </Link>
              <Link
              ...
              <a
                href="#Pricing"
                className="text-1xl block font-bold  text-white  mb-1 cursor-pointer hover:duration-300 hover:text-[#0EE6B8] hover:ms-2"
              >
                Pricing
              </a>
            </div>
          ...
          <div className="w-full">
            <div className=" lg:text-left md:text-center sm:text-center">
              ...
              <Link
                href={"/courses"}
                className="mt-3 text-1xl block font-bold  mb-1 cursor-pointer hover:duration-300 hover:text-[#0EE6B8] hover:ms-2"
              >
                All Courses
              </Link>
              <Link
              ...
              <a
                href="#Premium "
                className="text-1xl block font-bold  mb-1 cursor-pointer hover:duration-300 hover:text-[#0EE6B8] hover:ms-2"
              >
                Premium
              </a>
            </div>
